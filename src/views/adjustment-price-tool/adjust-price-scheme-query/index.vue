<template>
  <div class="AdjustPriceSchemeQuery">
    <!-- 调价方案查询 -->
    <section class="layer">
      <el-row :gutter="10">
        <el-col :span="24">
...
import CpiDialog from './cpi-dialog'
import SerDialog from './ser-dialog'
import PreDialog from './pre-dialog'
import PcmDialog from './pcm-dialog'
