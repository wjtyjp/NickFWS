<template>
  <div class="">
    <el-dialog :close-on-click-modal="false" :visible.sync="costObj.isShow" title="成本测算调价" width="60%" @close="cancelDialog">
        ...
        <el-row :gutter="16">
          ...
          <el-col :span="6">
            <el-form-item label="统筹区">
              <el-input v-model="ruleForm.labl" readonly />
            </el-form-item>
          </el-col>
          <el-col :span="6">
        ...
        <el-row :gutter="16">
          <el-col :span="6">
            <el-form-item label="调整项目数">
              <el-input v-model="ruleForm.adjmItemCnt" readonly />
            </el-form-item>
          </el-col>
          <el-col :span="12">
      ...
      <el-table :data="tableData" :height="300" highlight-current-row>
        ...
        <el-table-column show-overflow-tooltip prop="highLmtprc" label="价格(元)" align="center" />
...
export default {
  ...
  created() {
    this.$nextTick(() => {
      this.ruleForm = this.costObj.costData.adjmSchm
      this.tableData = this.costObj.costData.lstAdjmSchmItem
    })
  },
  mounted() {
