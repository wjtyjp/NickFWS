<template>
  <div>
                  ...
                  <el-table v-loading="table.loading" ref="table" :data="table.tableData" :height="table.tableHeight" row-key="taskId" style="width: 100%" fit>
                    ...
                    <el-table-column label="操作" width="120" align="center">
                      <template slot-scope="scope">
                        <el-button type="text" @click="handle(scope.row)">查看详情</el-button>
                      </template>
                    </el-table-column>
                    <el-table-column prop="poolarea" label="统筹区" show-overflow-tooltip align="center" />
                    <el-table-column prop="adjmprcSumamt" label="调价总额度" show-overflow-tooltip align="center" />
                    ...
                    <el-table-column prop="dclaBegntime" label="申报开始时间" show-overflow-tooltip align="center" />
                    <el-table-column prop="dclaEndtime" label="申报结束时间" show-overflow-tooltip align="center" />
    ...
    <handle-item ref="handleItems" :show="dialogShow" @closeHandle="closeHandle" />
  </div>
</template>
